# -*- coding: utf-8 -*-
# this is borrowed from https://github.com/Drekin/win-unicode-console released under MIT license
# and slightly modified

# TODO: after switching to Python 3.6 this must be removed - 3.6 implements this functionality internally!
...
import ctypes
from ctypes import (byref, POINTER, pythonapi, c_int, c_char, c_char_p, c_void_p, py_object, c_ssize_t, c_ulong)
...
def enable(stdin=Ellipsis, stdout=Ellipsis, stderr=Ellipsis):
    ...
    # defaults transcoding because Python tokenizer cannot handle UTF-16
