...
def _parseNames(numpages, data, log):
    ...
    for m in re.finditer(_tup_pattern, data):
        ...
        for i in range(spos - 1, numpages):
            if nametype == 'r':
                ...
                log.warning("Error: unknown page numbering type: {0}".format(nametype))
            pagenames[i] = pname
...
class PageMapProcessor:
    ...
    def __init__(self, data, log):
        ...
        self.pagenames, self.pageMap = _parseNames(self.pm_nn, self.pmstr, log)
