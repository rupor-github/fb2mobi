...
class Ui_SettingsDialog(object):
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.groupBox.setTitle(_translate("SettingsDialog", "Параметры конвертации"))
        self.label.setText(_translate("SettingsDialog", "Профиль"))
        self.label_2.setText(_translate("SettingsDialog", "Формат"))
        self.groupBox_3.setTitle(_translate("SettingsDialog", "Расставлять мягкие переносы"))
        self.radioHypYes.setText(_translate("SettingsDialog", "Да"))
        self.radioHypNo.setText(_translate("SettingsDialog", "Нет"))
        self.radioHypProfile.setText(_translate("SettingsDialog", "Как в профиле"))
        self.label_3.setText(_translate("SettingsDialog", "Конвертировать в папку"))
        self.btnSelectDestPath.setText(_translate("SettingsDialog", "Выбрать"))
        self.checkConvertToSrc.setText(_translate("SettingsDialog", "Конвертировать в исходную папку"))
        self.groupBox_2.setTitle(_translate("SettingsDialog", "Kindle"))
        self.label_4.setText(_translate("SettingsDialog", "Папка \"documents\" устройства"))
        self.btnSelectKindlePath.setText(_translate("SettingsDialog", "Выбрать"))
        self.checkCopyAfterConvert.setText(_translate("SettingsDialog", "Копировать на устройство после конвертации"))
        self.checkSyncCovers.setText(_translate("SettingsDialog", "Синхронизировать обложки"))
